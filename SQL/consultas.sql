...
-- quais os usernames das contas que fizeram avaliações de obras na mesma data --
--e com as mesmas estrelas da conta de username 'joao.s' (SUBCONSULTA TIPO LINHA) --
SELECT username
FROM Avalia a 
